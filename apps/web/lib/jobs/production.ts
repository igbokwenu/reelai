...
${scene.storyboard.razzmatazzMode ? "RAZZMATAZZ LOCK: the intact product is the only subject and must read as the centered, sole-focus hero. Compose the opening instant at the onset of its planned spin, partial turn, pivot, rise, or forward glide, with enough clean silhouette space for that motion to remain stable. One active surrounding effect—such as light streaks, a rim-light pulse, particle halo, reflection burst, color bloom, or shadow pulse—must already be visibly beginning behind or around the product without touching, obscuring, recoloring, or reshaping it. Static soft focus, bokeh, condensation, or pretty illumination alone is not Razzmatazz. Use no person, detached hand, opened package, separated component, or product transformation. Reserve clean negative space for the renderer's brief tagline." : ""}
